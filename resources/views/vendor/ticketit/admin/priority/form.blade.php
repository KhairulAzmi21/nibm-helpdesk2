...
<div class="form-group">
           {!! CollectiveForm::label('days', trans('ticketit::admin.priority-create-days') . trans('ticketit::admin.colon'), ['class' => 'col-lg-2 control-label']) !!}
    <div class="col-lg-10">
        {!! CollectiveForm::number('days', isset($priority->number) ? $priority->number : null, ['class' => 'form-control']) !!}
    </div>
</div>
