...
class TicketitServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (empty($installer->inactiveMigrations()) && !$installer->inactiveSettings()) {
            ...
            $this->loadTranslationsFrom(base_path('vendor/kordy/ticketit/src/Translations'), 'ticketit');

            $this->loadViewsFrom(base_path('vendor/kordy/ticketit/src/Views'), 'ticketit');

            $this->publishes([base_path('vendor/kordy/ticketit/src/Views') => base_path('resources/views/vendor/ticketit')], 'views');
            $this->publishes([base_path('vendor/kordy/ticketit/src/Translations') => base_path('resources/lang/vendor/ticketit')], 'lang');
            $this->publishes([base_path('vendor/kordy/ticketit/src/Public') => public_path('vendor/ticketit')], 'public');
...
//            $installer->publicAssets();
            ...
            //include base_path('routes/helpdesk_routess.php');
