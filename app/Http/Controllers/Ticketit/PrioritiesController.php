...
namespace App\Http\Controllers\Ticketit;
...
class PrioritiesController extends TicketsController
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Ticketit\PrioritiesController@index');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $priority = Priority::findOrFail($id);
        $priority->update(['name' => $request->name, 'color' => $request->color,  'days' => $request->days]);
